...
| Business | 解析音声の00:00-29:50のトトト間隔を再現 | 200Hz | 同一 | 3.54〜11.92Hzの可変パルス | ピンクノイズ |
| Creative | 解析音声の30:00-50:00のトトト間隔を再現 | 200Hz | 同一 | 2.53〜11.7Hzの可変パルス | ピンクノイズ |
...
- Businessを選ぶとタイマーは自動で29:50、Creativeを選ぶと自動で20:00になります。
