...
| クリエイティブ | 解析音声の30:00-50:00のトトト間隔を再現 | 200Hz | 同一 | 2.53〜11.7Hzの可変パルス | ピンクノイズ |
...
- クリエイティブ: 音の高さは200Hzで固定し、音声解析で抽出した30:00-50:00のトトト間隔をもとに、約2.53〜11.7Hzの範囲でパルス速度を変化させるモードです。
- ビジネスを選ぶとタイマーは自動で29:50、クリエイティブを選ぶと自動で20:00になります。
