...
| ビジネス | 解析音声の00:00-29:50だけを再現する6kHzカーブ | 5984Hz→5998.1Hz | 同一 | 0Hz | ピンクノイズ |
...
- ビジネス: 音声解析で抽出した00:00-29:50の5〜7kHz帯平均周波数をもとに、約5984Hzから約5998.1Hzまでゆるやかに動かすモードです。
- このモードを選ぶとタイマーは自動で29:50になります。
- 高めの周波数なので、初期音量は控えめにしています。
