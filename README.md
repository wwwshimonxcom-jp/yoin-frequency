...
| ビジネス | 解析音声の00:00-29:50のトトト間隔を再現 | 6000Hz | 同一 | 2.32〜10.65Hzの可変パルス | ピンクノイズ |
...
- ビジネス: 音の高さは6000Hzで固定し、音声解析で抽出した00:00-29:50のトトト間隔をもとに、約2.32〜10.65Hzの範囲でパルス速度を変化させるモードです。
